      ...
      <div className="px-3 md:px-8 lg:px-8">
        <div className={`${styles["features__title"]} text-center mb-[50px]`}>
          <h3 className="text-[15px] md:text-base lg:text-base">
            {t("our-features.Our Features")}
          </h3>
          <h2 className="text-[28px] md:text-[40px] lg:text-[40px]">
            {t("our-features.Why You Should Choose Edmy")}
          </h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          <div
            className={`px-0 lg:px-3 md:px-3 mb-[30px] md:mb-0 lg:mb-0 cursor-pointer`}
          >
            <div
            ...
            >
              ...
              <h2 className="mt-[33px] mb-[20px]">
                {t("our-features.Expert-Led Video Courses")}
              </h2>
              <p className="text-center leading-7">
                {t(
                  "our-features.Instructors from around the world teach millions of students on Edmy through video."
                )}
              </p>
            </div>
          </div>
